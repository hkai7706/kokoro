...
<body class="font-sans bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="text-center max-w-md">
        ...
        <p class="text-sm text-gray-400 mb-6" data-en="The page you're looking for doesn't exist or has been moved." data-jp="お探しのページは存在しないか、移動されました。">The page you're looking for doesn't exist or has been moved.</p>
