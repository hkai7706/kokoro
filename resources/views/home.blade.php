...
function openGameModal(h){const gc=document.getElementById('game-content');gc.innerHTML=h;gc.classList.remove('hidden');document.getElementById('game-modal').classList.remove('hidden')}
