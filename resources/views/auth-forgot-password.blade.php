    ...
    <div class="w-full max-w-sm">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-400 text-sm mt-2" data-en="Reset your password" data-jp="パスワードをリセット">Reset your password</p>
            </div>
            ...
            <p class="text-xs text-gray-400 mb-4" data-en="Enter your email address and we'll send you a link to reset your password." data-jp="メールアドレスを入力すると、パスワードリセットリンクが送信されます。">Enter your email address and we'll send you a link to reset your password.</p>
