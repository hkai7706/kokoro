...
<body class="font-sans bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-sm">
        <div class="bg-white rounded-xl border border-gray-200 p-6 text-center">
            ...
            <p class="text-sm text-gray-600 mb-5" data-en="We've sent a verification link to your email. Please check your inbox and click the link to verify." data-jp="確認リンクをメールに送信しました。受信箱を確認し、リンクをクリックして確認してください。">We've sent a verification link to your email. Please check your inbox and click the link to verify.</p>
            ...
            <a href="{{ route('home') }}" class="text-sm text-gray-500 hover:text-gray-600 transition" data-en="Skip for now" data-jp="後で確認する">Skip for now</a>
        </div>
    </div>
    <script>
