    ...
    <div class="w-full max-w-sm">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-400 text-sm mt-2" data-en="Set your new password" data-jp="新しいパスワードを設定">Set your new password</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="space-y-3.5">
                    ...
                    <div>
                        <label class="block text-[11px] font-medium text-gray-500 mb-1" data-en="New Password" data-jp="新しいパスワード">New Password</label>
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword('reset-password', this)" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition">
                    ...
                    <div>
                        <label class="block text-[11px] font-medium text-gray-500 mb-1" data-en="Confirm New Password" data-jp="新しいパスワード確認">Confirm New Password</label>
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword('reset-password-confirm', this)" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition">
                                <svg class="w-4 h-4 eye-open" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                <svg class="w-4 h-4 eye-closed hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L6.59 6.59m7.532 7.532l3.29 3.29M3 3l18 18"/></svg>
                            </button>
                        </div>
