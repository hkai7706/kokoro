...
<body class="font-sans text-gray-800 antialiased bg-white">
    ...
    {{-- Skip to content --}}
    <a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-[999] focus:bg-rose-500 focus:text-white focus:px-4 focus:py-2 focus:rounded-lg focus:text-sm focus:outline-none">Skip to main content</a>
    ...
    <header class="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-gray-200/60" role="banner">
        <nav class="max-w-5xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14" aria-label="Main navigation">
            ...
            <ul class="hidden md:flex items-center gap-5 text-[13px] list-none m-0 p-0" role="list">
                <li><a href="#how-it-works" class="text-gray-600 hover:text-gray-800 transition">How it works</a></li>
                <li><a href="#features" class="text-gray-600 hover:text-gray-800 transition">Features</a></li>
                <li><a href="#stories" class="text-gray-600 hover:text-gray-800 transition">Stories</a></li>
            </ul>
    ...
    <section class="pt-14" aria-label="Hero">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-28">
            ...
            <div class="mt-14 grid grid-cols-3 gap-6 max-w-sm fade-in fade-in-d3" aria-label="Platform statistics">
                <div>
                    <div class="text-xl font-bold text-gray-900">50K+</div>
                    <div class="text-gray-600 text-xs mt-0.5">Members</div>
                </div>
                <div>
                    <div class="text-xl font-bold text-gray-900">12K+</div>
                    <div class="text-gray-600 text-xs mt-0.5">Matches</div>
                </div>
                <div>
                    <div class="text-xl font-bold text-gray-900">4.8</div>
                    <div class="text-gray-600 text-xs mt-0.5">User rating</div>
                </div>
            </div>
        </div>
    </section>
    ...
    {{-- How It Works --}}
    <section id="how-it-works" class="py-16 border-t border-gray-100" aria-labelledby="hiw-heading">
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 id="hiw-heading" class="text-xl font-bold text-gray-900 mb-1">How it works</h2>
            <p class="text-sm text-gray-600 mb-10">Three steps. That's it.</p>

            <div class="grid md:grid-cols-3 gap-6">
                <div class="p-5 rounded-xl border border-gray-200/60">
                    <div class="w-8 h-8 bg-rose-50 rounded-lg flex items-center justify-center mb-3" aria-hidden="true">
                        <span class="text-rose-500 text-sm font-bold">1</span>
                    </div>
                    <h3 class="text-sm font-semibold mb-1.5">Create your profile</h3>
                    <p class="text-xs text-gray-600 leading-relaxed">Add your photo, hobbies, and a short bio. Takes about 2 minutes.</p>
                </div>
                <div class="p-5 rounded-xl border border-gray-200/60">
                    <div class="w-8 h-8 bg-amber-50 rounded-lg flex items-center justify-center mb-3" aria-hidden="true">
                        <span class="text-amber-600 text-sm font-bold">2</span>
                    </div>
                    <h3 class="text-sm font-semibold mb-1.5">Browse and like</h3>
                    <p class="text-xs text-gray-600 leading-relaxed">Search by prefecture, age, or interests. Like profiles that catch your eye.</p>
                </div>
                <div class="p-5 rounded-xl border border-gray-200/60">
                    <div class="w-8 h-8 bg-violet-50 rounded-lg flex items-center justify-center mb-3" aria-hidden="true">
                        <span class="text-violet-600 text-sm font-bold">3</span>
                    </div>
                    <h3 class="text-sm font-semibold mb-1.5">Match and talk</h3>
                    <p class="text-xs text-gray-600 leading-relaxed">When you both like each other, you can message directly. No middleman.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    {{-- Features --}}
    <section id="features" class="py-16 bg-gray-50/60 border-t border-gray-100" aria-labelledby="features-heading">
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 id="features-heading" class="text-xl font-bold text-gray-900 mb-1">Why people choose KOKORO</h2>
            <p class="text-sm text-gray-600 mb-10">Built for genuine connections, not engagement metrics.</p>

            <div class="grid sm:grid-cols-2 gap-5">
                <div class="flex gap-3.5 p-4 bg-white rounded-xl border border-gray-200/60">
                    <div class="w-9 h-9 bg-rose-50 rounded-lg flex items-center justify-center shrink-0 mt-0.5" aria-hidden="true">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600 leading-relaxed">Moderation and reporting keep the community real. No bots, no spam.</p>
                    </div>
                </div>
                <div class="flex gap-3.5 p-4 bg-white rounded-xl border border-gray-200/60">
                    <div class="w-9 h-9 bg-emerald-50 rounded-lg flex items-center justify-center shrink-0 mt-0.5" aria-hidden="true">
                        <svg class="w-4 h-4 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/></svg>
                    </div>
                    <div>
                        <h3 class="text-sm font-semibold mb-0.5">All 47 prefectures</h3>
                        <p class="text-xs text-gray-600 leading-relaxed">Find people near you or anywhere in Japan with location-based search.</p>
                    </div>
                </div>
                <div class="flex gap-3.5 p-4 bg-white rounded-xl border border-gray-200/60">
                    <div class="w-9 h-9 bg-violet-50 rounded-lg flex items-center justify-center shrink-0 mt-0.5" aria-hidden="true">
                        <svg class="w-4 h-4 text-violet-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
                    </div>
                    <div>
                        <h3 class="text-sm font-semibold mb-0.5">Compatibility scores</h3>
                        <p class="text-xs text-gray-600 leading-relaxed">We compare hobbies, interests, and location to show how well you match.</p>
                    </div>
                </div>
                <div class="flex gap-3.5 p-4 bg-white rounded-xl border border-gray-200/60">
                    <div class="w-9 h-9 bg-amber-50 rounded-lg flex items-center justify-center shrink-0 mt-0.5" aria-hidden="true">
                        <svg class="w-4 h-4 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                    </div>
                    <div>
                        <h3 class="text-sm font-semibold mb-0.5">Mutual matching</h3>
                        <p class="text-xs text-gray-600 leading-relaxed">Chat only opens when both people say yes. No unwanted messages.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- Testimonials --}}
    <section id="stories" class="py-16 border-t border-gray-100" aria-labelledby="stories-heading">
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 id="stories-heading" class="text-xl font-bold text-gray-900 mb-1">People who found each other</h2>
            <p class="text-sm text-gray-600 mb-10">Real stories from KOKORO members.</p>
            ...
            <div class="grid md:grid-cols-3 gap-5">
                ...
                <blockquote class="p-5 rounded-xl border border-gray-200/60">
                    <p class="text-sm text-gray-600 leading-relaxed mb-4">"{{ $story['text'] }}"</p>
                    <footer class="flex items-center gap-2.5">
                        <div class="w-8 h-8 bg-rose-50 rounded-full flex items-center justify-center text-rose-500 text-xs font-bold" aria-hidden="true">
                            {{ substr($story['name'], 0, 1) }}
                        </div>
                        <div>
                            <cite class="text-xs font-semibold text-gray-700 not-italic">{{ $story['name'] }}</cite>
    ...
    {{-- CTA --}}
    <section class="py-16 bg-gray-50 border-t border-gray-100" aria-label="Call to action">
        <div class="max-w-xl mx-auto px-4 text-center">
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Ready to meet someone?</h2>
            <p class="text-sm text-gray-600 mb-6">Creating an account takes less than a minute. Free to join.</p>
    ...
    {{-- Footer --}}
    <footer class="bg-gray-900 text-gray-300 py-10" role="contentinfo">
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <nav aria-label="Platform links">
                    <h3 class="text-white text-xs font-semibold mb-2.5">Platform</h3>
                    <ul class="space-y-1.5 text-xs list-none m-0 p-0" role="list">
                ...
                <nav aria-label="Legal links">
                    <h3 class="text-white text-xs font-semibold mb-2.5">Legal</h3>
                    <ul class="space-y-1.5 text-xs list-none m-0 p-0" role="list">
                ...
                <nav aria-label="Support links">
                    <h3 class="text-white text-xs font-semibold mb-2.5">Support</h3>
                    <ul class="space-y-1.5 text-xs list-none m-0 p-0" role="list">
                        ...
                        <li><a href="/safety" class="hover:text-white transition">Safety Tips</a></li>
                    </ul>
                </nav>
            </div>
            <div class="mt-8 pt-5 border-t border-gray-800 text-center text-xs text-gray-300">
    ...
    {{-- Cookie Consent --}}
    <div id="cookie-consent" class="fixed bottom-0 left-0 right-0 bg-gray-900/95 backdrop-blur-md text-white p-3 z-50" style="display:none;" role="region" aria-label="Cookie consent">
